...
import 'package:smart_door/utils/api/updatememberapi.dart';
import 'package:toggle_switch/toggle_switch.dart';

class Updatemember extends StatefulWidget {
  Updatemember({super.key, this.memberdata,});
  final memberdata;
                        ...
                        FadeInUp(
                          ...
                          if (formKey.currentState!.validate()) {
                            ...
                            Map<String, dynamic> data = {
                             ...
                             String imagePath = '$baseUrl/static/photo/${widget.memberdata[0]['Photo']}';
                                                File imageFile =
                                                    File(imagePath);
                            
                            await updateMember(data,_image!,context);
                          }
                        },
                              child: Container(
                                height: 50,
